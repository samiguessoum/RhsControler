...
import { loginSchema, createUserSchema, updateUserSchema, createClientSchema, updateClientSchema, createPrestationSchema, updatePrestationSchema, createPosteSchema, updatePosteSchema, createEmployeSchema, updateEmployeSchema, createContratSchema, updateContratSchema, createInterventionSchema, updateInterventionSchema, realiserInterventionSchema, reporterInterventionSchema, annulerInterventionSchema, createCongeSchema, approuverCongeSchema, createWeekendTravailleSchema, updateSoldeSchema, 
// Tiers
createTiersSchema, updateTiersSchema, createContactSchema, updateContactSchema, createAdresseSchema, updateAdresseSchema, createCompteBancaireSchema, updateCompteBancaireSchema, createModePaiementSchema, createConditionPaiementSchema, 
// Sites
createSiteSchema, updateSiteSchema, createSiteContactSchema, updateSiteContactSchema, 
// Produits/Services (Dolibarr-style)
createProduitServiceSchema, updateProduitServiceSchema, createCategorieProduitSchema, updateCategorieProduitSchema, createEntrepotSchema, updateEntrepotSchema, createPrixFournisseurSchema, updatePrixFournisseurSchema, createPrixClientSchema, updatePrixClientSchema, createMouvementProduitServiceSchema, 
// Commerce
createDevisSchema, updateDevisSchema, createCommandeSchema, updateCommandeSchema, createBonLivraisonSchema, updateBonLivraisonSchema, createFactureSchema, updateFactureSchema, createPaiementSchema, updateStatutChequeSchema, createFactureRelanceSchema, 
// Commandes Fournisseurs
createCommandeFournisseurSchema, updateCommandeFournisseurSchema, receptionCommandeFournisseurSchema, 
// Facturation
createFactureFournisseurSchema, updateFactureFournisseurSchema, createPaiementFournisseurSchema, createChargeSchema, updateChargeSchema, createPaiementChargeSchema, createPaiementDiversSchema, updatePaiementDiversSchema, } from '../validators/schemas.js';
...
const ficheTechniqueStorage = multer.diskStorage({
    ...
    filename: (req, file, cb) => {
        ...
        cb(null, `fiche-${req.params?.id || 'unknown'}-${Date.now()}${ext}`);
    },
});
...
router.get('/rh/soldes/mouvements', authMiddleware, canDo('viewRH'), rhController.listMouvements);
router.post('/rh/soldes/crediter-mois', authMiddleware, canDo('manageRH'), rhController.crediterMois);
router.post('/rh/soldes/cloture-annee', authMiddleware, canDo('manageRH'), rhController.cloturerAnnee);
router.post('/rh/soldes/:employeId/ajuster', authMiddleware, canDo('manageRH'), rhController.ajusterSolde);
// Weekend travaillés
...
router.post('/commerce/devis/:id/valider', authMiddleware, canDo('manageCommerce'), commerceController.validerDevis);
...
router.post('/commerce/factures/:id/valider', authMiddleware, canDo('manageCommerce'), commerceController.validerFacture);
...
router.post('/commandes-fournisseurs/:id/valider', authMiddleware, canDo('manageCommerce'), commandeFournisseurController.valider);
// ============ FACTURATION ============
...
router.post('/factures-fournisseurs/:id/valider', authMiddleware, canDo('manageFacturation'), factureFournisseurController.valider);
// Charges
