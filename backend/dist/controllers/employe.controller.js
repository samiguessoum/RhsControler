...
async function crediterCongesInitiaux(employeId, dateEntree, auteurId) {
...
export const employeController = {
            ...
            const employe = await prisma.employe.update({
                ...
                data: {
                    ...
                    ...(dateEntree !== undefined
                        ...
                        : {}),
                    postes: posteIds
                        ? { set: [], connect: posteIds.map((pid) => ({ id: pid })) }
                        : undefined,
                },
                include: { postes: true },
            });
     ...
     */
    async interventionsCount(req, res, next) {
        try {
            const { id } = req.params;
